...
testdata_cfht is test data used to exercise the LSST Stack.


git-lfs
-------

testdata_cfht stores large files using [git-lfs](https://git-lfs.github.com/). To use testdata_cfht you must install git-lfs and configure it. LSST runs its own git-lfs server and storage service.
...
```bash
git clone https://github.com/lsst/testdata_cfht.git
```
